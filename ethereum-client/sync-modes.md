...
* fast sync
  ...
  * if you have a good connection and a reasonable machine then setting ActivePeersMaxCount to 256 \(see SyncConfig secion in configuration\) should give much better fast sync times \(we use 256 peers to get 5 hours syncs\)
* beam sync
